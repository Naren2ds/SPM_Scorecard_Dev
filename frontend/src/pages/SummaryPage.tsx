...
const KPI_BUDGET = [
  ...
  { kpi: "Price Divergence", pillar: "Operational", input: "ABS(Invoice Value \u2212 PO Value) / PO Value (lower = better)", floor: "25%", target: "19.9%", max: 5 },
  ...
  { kpi: "Supplier Maturity Score", pillar: "Sustainability", input: "0\u2013100 maturity score", floor: "60", target: "80", max: 10 },
